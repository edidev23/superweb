        ...
        document.getElementById("header-lang-img") &&
            ("en" == e
                ? (document.getElementById("header-lang-img").src =
                      origin + "/assets/images/flags/us.svg")
                : "sp" == e
                ? (document.getElementById("header-lang-img").src =
                      origin + "/assets/images/flags/spain.svg")
                : "gr" == e
                ? (document.getElementById("header-lang-img").src =
                      origin + "/assets/images/flags/germany.svg")
                : "it" == e
                ? (document.getElementById("header-lang-img").src =
                      origin + "/assets/images/flags/italy.svg")
                : "ru" == e
                ? (document.getElementById("header-lang-img").src =
                      origin + "/assets/images/flags/russia.svg")
                : "ch" == e
                ? (document.getElementById("header-lang-img").src =
                      origin + "/assets/images/flags/china.svg")
                : "fr" == e
                ? (document.getElementById("header-lang-img").src =
                      origin + "/assets/images/flags/french.svg")
                : "ar" == e &&
                  (document.getElementById("header-lang-img").src =
                      origin + "/assets/images/flags/ae.svg"),
            localStorage.setItem("language", e),
            null == (y = localStorage.getItem("language")) && p(b),
            (e = new XMLHttpRequest()).open(
                "GET",
                origin + "/assets/lang/" + y + ".json"
            ),
