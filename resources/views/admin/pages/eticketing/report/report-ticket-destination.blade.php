    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Laporan Ticket Semua Destinasi</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Rekap data tiket di semua destinasi</h4>
                </div>
                        ...
                        <table class="table table-hover table-striped-columns align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="money">Rp. 25.000</td>
                                    <td class="money">Rp. 0</td>
                                    <td class="money">Rp. 25.000</td>
                                    <td class="money">Rp. 2.500</td>
                                </tr>
